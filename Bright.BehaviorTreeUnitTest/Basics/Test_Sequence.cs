...
namespace Pefect.BehaviorTreeUnitTest
{
    ...
    {
        [TestMethod]
        public void Test_NotChild_Succ()
        {

            var bt = new BehaviorTreeObject(1, null);


            var root = new Sequence(bt, 1, null, null, new List<AbstractFlowNode> { });
            bt.SetRoot(root);
        ...
        [TestMethod]
        public void TwoTask_SuccSucc_Succ()
        {
        ...
        [TestMethod]
        public void TwoTask_SuccFail_Fail()
        {
        ...
        [TestMethod]
        public void TwoTask_SuccAbort_Fail()
        {
            ...
            Assert.IsFalse(t2.IsExecuting);
            Assert.AreEqual(ENodeResult.ABORT, t2.OriginResult);
            Assert.AreEqual(ENodeResult.ABORT, t2.FinalResult);
        }

        [TestMethod]
        public void TwoTask_Fail_Fail()
        {
        ...
        [TestMethod]
        public void TwoTask_Abort_Fail()
        {
